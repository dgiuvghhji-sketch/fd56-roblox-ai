...
function callGeminiAPI(username, promptText, callback) {
    ...
    const systemInstruction = `أنت مساعد ذكاء اصطناعي خاص بالنظام. أنت تتحدث الآن مع المستخدم "${username}". رد عليه كشنسان حقيقي وبشكل مباشر ومرتب باسمه، وبدون ذكر أنك نموذج لغوي ما لم يطلب ذلك.`;
        ...
        res.on('end', () => {
            try {
                ...
                if (parsed.candidates && 
                    ...
                    callback(null, "خطأ من الخادم: " + (parsed.error.message || "تأكد من مفتاح الـ API في Render"));
                } else {
...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; }
        ...
        /* زيادة إضاءة ووضوح الخلايا العصبية والخطوط */
        ...
        /* تعديل الأماكن: رسائل المستخدم يمين، ورسائل الذكاء الاصطناعي يسار */
...
<body>
    ...
    <script>
        ...
        // إضاءة ووضوح عالي للنقاط والخطوط العصبية
        for (let i = 0; i < 65; i++) {
